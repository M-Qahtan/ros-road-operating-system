...
const REQUIRED_RUNTIME_RELATIONS = Object.freeze([
  ...
  'ros_eye_safety_fusion_recommendation_journal',
  'ros_eye_safety_fusion_input_snapshots',
  'ros_eye_cognitive_input_snapshot_bindings',
  'road_event_closure_authorization_journal',
...
const REQUIRED_RUNTIME_COLUMNS = Object.freeze([
  ...
  { tableName: 'road_events', columnName: 'closure_cognitive_policy_version' },
  { tableName: 'road_events', columnName: 'closure_cognitive_revision' },
  { tableName: 'road_events', columnName: 'closure_cognitive_digest' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'tenant_id' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'purpose' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'case_id' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'event_version' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'authorized_by' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'source_input_version' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'source_snapshot_digest' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'cognitive_policy_version' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'cognitive_revision' },
  { tableName: 'road_event_closure_authorization_journal', columnName: 'cognitive_digest' },
  ...
  { tableName: 'ros_eye_cognitive_input_snapshot_bindings', columnName: 'tenant_id' },
  { tableName: 'ros_eye_cognitive_input_snapshot_bindings', columnName: 'purpose' },
  { tableName: 'ros_eye_cognitive_input_snapshot_bindings', columnName: 'case_id' },
  { tableName: 'ros_eye_cognitive_input_snapshot_bindings', columnName: 'policy_version' },
  { tableName: 'ros_eye_cognitive_input_snapshot_bindings', columnName: 'cognitive_revision' },
  { tableName: 'ros_eye_cognitive_input_snapshot_bindings', columnName: 'cognitive_digest' },
  { tableName: 'ros_eye_cognitive_input_snapshot_bindings', columnName: 'cognitive_requires_abstention' },
  { tableName: 'ros_eye_safety_fusion_recommendation_journal', columnName: 'tenant_id' },
  { tableName: 'ros_eye_safety_fusion_recommendation_journal', columnName: 'purpose' },
  { tableName: 'ros_eye_safety_fusion_recommendation_journal', columnName: 'case_id' },
  { tableName: 'ros_eye_safety_fusion_recommendation_journal', columnName: 'cognitive_snapshot_policy_version' },
  { tableName: 'ros_eye_safety_fusion_recommendation_journal', columnName: 'cognitive_revision' },
  { tableName: 'ros_eye_safety_fusion_recommendation_journal', columnName: 'cognitive_digest' },
  { tableName: 'ros_eye_safety_fusion_recommendation_journal', columnName: 'cognitive_requires_abstention' },
  { tableName: 'road_event_revision_ledger', columnName: 'tenant_id' },
  { tableName: 'road_event_revision_ledger', columnName: 'purpose' },
  { tableName: 'road_event_revision_ledger', columnName: 'case_id' },
  { tableName: 'road_event_revision_ledger', columnName: 'component' },
  { tableName: 'ros_eye_contact_revision_ledger', columnName: 'tenant_id' },
  { tableName: 'ros_eye_contact_revision_ledger', columnName: 'purpose' },
  { tableName: 'ros_eye_contact_revision_ledger', columnName: 'case_id' },
  { tableName: 'ros_eye_contact_revision_ledger', columnName: 'revision' },
