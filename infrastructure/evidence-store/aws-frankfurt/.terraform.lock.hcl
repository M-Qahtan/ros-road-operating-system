...
# It is copied from the already reviewed REL-013 root because this Frankfurt
# root uses the same Terraform AWS provider constraint. Regeneration requires
# a separately reviewed provider-lock update.
